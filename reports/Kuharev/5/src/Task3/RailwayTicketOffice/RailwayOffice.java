...
public class RailwayOffice {
    static private ArrayList<Train> trains = new ArrayList<Train>();
...
//    }
    ...
    private static class Schedule{
        ...
        public static void addParagraph(String newstation, Train newtrain, LocalDateTime dateTime, Integer newtickets_amount, Integer newticket_price){
            ...
            int size = date_time.size();
            if(size == 0){
                isAdded = false;
            }else{
                for(int i = 0; i < size; ++i){
                    if(dateTime.isBefore(date_time.get(i))){
                        System.out.println(i);
                        //System.out.println("this  0837092y78wge7821te712t7");
                        isAdded = true;
